...
public class TDriver
    ...
    public static void resultPrinting(String path) throws IOException {
        ...
        //store in hash map to retrieve it based on country
        System.out.println("####################\n####################");
        while (line != null) {
        ...
        for (String state : states) {
            ...
            Integer all_tweets = map.get(state);

            if (all_tweets != null) {
                all = all_tweets;
                common_p = map.get(state + "_" + "Common") / (double) all;
                trump_p = map.get(state + "_" + "Trump") / (double) all;
                biden_p = map.get(state + "_" + "Biden") / (double) all;
            }

            System.out.println(state + "   " + common_p + "   " +
                    biden_p + "   " + trump_p + "    " + all);
        }
        System.out.println("####################\n####################");
    }
